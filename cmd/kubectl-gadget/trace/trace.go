...
import (
	...
	bindtypes "github.com/kinvolk/inspektor-gadget/pkg/gadgets/bindsnoop/types"
	capabilitiestypes "github.com/kinvolk/inspektor-gadget/pkg/gadgets/capabilities/types"
	dnstypes "github.com/kinvolk/inspektor-gadget/pkg/gadgets/dns/types"
	exectypes "github.com/kinvolk/inspektor-gadget/pkg/gadgets/execsnoop/types"
	fsslowertypes "github.com/kinvolk/inspektor-gadget/pkg/gadgets/fsslower/types"
	mounttypes "github.com/kinvolk/inspektor-gadget/pkg/gadgets/mountsnoop/types"
	oomkilltypes "github.com/kinvolk/inspektor-gadget/pkg/gadgets/oomkill/types"
	opentypes "github.com/kinvolk/inspektor-gadget/pkg/gadgets/opensnoop/types"
	signaltypes "github.com/kinvolk/inspektor-gadget/pkg/gadgets/sigsnoop/types"
	snitypes "github.com/kinvolk/inspektor-gadget/pkg/gadgets/snisnoop/types"
	tcpconnecttypes "github.com/kinvolk/inspektor-gadget/pkg/gadgets/tcpconnect/types"
	tcptypes "github.com/kinvolk/inspektor-gadget/pkg/gadgets/tcptracer/types"
...
type TraceEvent interface {
	bindtypes.Event | capabilitiestypes.Event | dnstypes.Event |
		exectypes.Event | fsslowertypes.Event | mounttypes.Event |
		oomkilltypes.Event | opentypes.Event | signaltypes.Event |
		snitypes.Event | tcptypes.Event | tcpconnecttypes.Event

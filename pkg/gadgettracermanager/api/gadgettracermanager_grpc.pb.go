...
type GadgetTracerManagerClient interface {
	...
	StreamTrace(ctx context.Context, in *TraceRequest, opts ...grpc.CallOption) (GadgetTracerManager_StreamTraceClient, error)
	ExecTrace(ctx context.Context, in *TraceRequest, opts ...grpc.CallOption) (*TraceResponse, error)
}
...
func (c *gadgetTracerManagerClient) StreamTrace(ctx context.Context, in *TraceRequest, opts ...grpc.CallOption) (GadgetTracerManager_StreamTraceClient, error) {
	stream, err := c.cc.NewStream(ctx, &GadgetTracerManager_ServiceDesc.Streams[1], "/gadgettracermanager.GadgetTracerManager/StreamTrace", opts...)
	if err != nil {
		return nil, err
	}
	x := &gadgetTracerManagerStreamTraceClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type GadgetTracerManager_StreamTraceClient interface {
	Recv() (*StreamData, error)
	grpc.ClientStream
}

type gadgetTracerManagerStreamTraceClient struct {
	grpc.ClientStream
}

func (x *gadgetTracerManagerStreamTraceClient) Recv() (*StreamData, error) {
	m := new(StreamData)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *gadgetTracerManagerClient) ExecTrace(ctx context.Context, in *TraceRequest, opts ...grpc.CallOption) (*TraceResponse, error) {
	out := new(TraceResponse)
	err := c.cc.Invoke(ctx, "/gadgettracermanager.GadgetTracerManager/ExecTrace", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GadgetTracerManagerServer interface {
	...
	// New full-service methods
	StreamTrace(*TraceRequest, GadgetTracerManager_StreamTraceServer) error
	ExecTrace(context.Context, *TraceRequest) (*TraceResponse, error)
...
func (UnimplementedGadgetTracerManagerServer) StreamTrace(*TraceRequest, GadgetTracerManager_StreamTraceServer) error {
	return status.Errorf(codes.Unimplemented, "method StreamTrace not implemented")
}
func (UnimplementedGadgetTracerManagerServer) ExecTrace(context.Context, *TraceRequest) (*TraceResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ExecTrace not implemented")
}
...
func _GadgetTracerManager_StreamTrace_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(TraceRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(GadgetTracerManagerServer).StreamTrace(m, &gadgetTracerManagerStreamTraceServer{stream})
}

type GadgetTracerManager_StreamTraceServer interface {
	Send(*StreamData) error
	grpc.ServerStream
}

type gadgetTracerManagerStreamTraceServer struct {
	grpc.ServerStream
}

func (x *gadgetTracerManagerStreamTraceServer) Send(m *StreamData) error {
	return x.ServerStream.SendMsg(m)
}

func _GadgetTracerManager_ExecTrace_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TraceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GadgetTracerManagerServer).ExecTrace(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gadgettracermanager.GadgetTracerManager/ExecTrace",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GadgetTracerManagerServer).ExecTrace(ctx, req.(*TraceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GadgetTracerManager_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ExecTrace",
			Handler:    _GadgetTracerManager_ExecTrace_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		...
		},
		{
			...
			Handler:       _GadgetTracerManager_StreamTrace_Handler,
			ServerStreams: true,
		},
	},

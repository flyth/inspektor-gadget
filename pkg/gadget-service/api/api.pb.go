...
const (
	...
	Kind_Bytes   Kind = 14
	// Struct types (25+)
	Kind_Kind_Struct      Kind = 25 // Embedded struct (protobuf-encoded)
	Kind_Kind_StructArray Kind = 26 // Array of structs (protobuf-encoded)
)
...
const file_api_api_proto_rawDesc = "" +
	...
	"\vKind_Struct\x10\x19\x12\x14\n" +
	"\x10Kind_StructArray\x10\x1a*M\n" +

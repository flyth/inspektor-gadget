...
// WithShowRowDivider sets whether a row divider should be shown between header and content
func WithShowRowDivider(show bool) Option {
	return func(opts *Options) {
		opts.ShowRowDivider = show
	}
}

...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -target $TARGET -cc clang auditseccomp ./bpf/audit-seccomp.c -- -I./bpf/ -I../../../ -I../../../${TARGET} -target bpf -D__KERNEL__
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -target $TARGET -cc clang auditseccompwithfilters ./bpf/audit-seccomp.c -- -DWITH_FILTER=1 -I./bpf/ -I../../../ -I../../../${TARGET} -target bpf -D__KERNEL__

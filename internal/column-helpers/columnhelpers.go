...
type ErrorCallback func(severity int, message string)
...
type Columns interface {
	...
	// JSONHandlerFunc returns a function that accepts a JSON encoded event, unmarshals it into *T and pushes it
...
func (ch *ColumnHelpers[T]) writeErrorMessage(severity int, message string) {

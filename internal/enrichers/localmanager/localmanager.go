...
func (l *LocalManager) CanEnrich(gadget gadgets.Gadget) bool {
...
func (l *LocalManager) Init(enricherParams params.Params) error {
	rp := params.ParamMapFromParams(enricherParams)
	runtimes := rp[Runtimes].String()
...
func (l *LocalManager) PreGadgetRun(runner enrichers.Runner, tracer any, perGadgetParams params.Params) (enrichers.Enricher, error) {
...
func init() {
	enrichers.RegisterEnricher(&LocalManager{})
}
